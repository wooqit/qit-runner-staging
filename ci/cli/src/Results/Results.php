...
abstract class Results {
	...
	public function __construct(
		...
		// Environment variables arrive as strings. In PHP, the non-empty string
		// "false" coerces to true when passed to a bool parameter, which caused
		// successful workflow runs to be reported to Manager as cancelled.
		$this->cancelled         = filter_var( $cancelled, FILTER_VALIDATE_BOOLEAN );
