...
try {
	...
	$application->add( $container->make( EcosystemUsageScanCommand::class ) );
	$application->add( $container->make( InternalUsageScanCommand::class ) );
	$application->add( $container->make( PhpstanRegressionDiffCommand::class ) );
