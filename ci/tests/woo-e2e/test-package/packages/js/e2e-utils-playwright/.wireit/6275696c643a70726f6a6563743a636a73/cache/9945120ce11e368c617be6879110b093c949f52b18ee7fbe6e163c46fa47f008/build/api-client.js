...
exports.WP_API_PATH = exports.WC_ADMIN_API_PATH = exports.WC_API_PATH = void 0;
...
function createClient(baseURL, auth) {
    ...
    if (auth.type === 'basic') {
        ...
        const isLocalhost = normalizedBaseURL.startsWith('http://localhost') ||
    ...
    function redact(obj, keys = [
        ...
        if (!obj || typeof obj !== 'object')
            return obj;
        return Object.fromEntries(Object.entries(obj).map(([k, v]) => keys.includes(k.toLowerCase())
            ? [k, '********']
            : [
                k,
                typeof v === 'object'
    ...
    function logRequest(label, details) {
        const redacted = Object.fromEntries(Object.entries(details).map(([k, v]) => [
            k,
            redact(v),
        ]));
    ...
    function oauthRequest(method, path, { params = {}, data = {}, debug = false } = {}) {
        ...
        if (method === 'GET') {
            ...
            Object.entries({ ...params, ...oauthParams }).forEach(([key, value]) => {
...
exports.WC_API_PATH = 'wc/v3';
exports.WC_ADMIN_API_PATH = 'wc-admin';
exports.WP_API_PATH = 'wp/v2';
