...
const reporter = [ [ 'playwright-ctrf-json-reporter', { outputDir: process.env.CTRF_OUTPUT_DIR || `${ TESTS_ROOT_PATH }/test-results`, outputFile: 'ctrf-report.json' } ],
	[ 'list' ],
	[
		'allure-playwright',
		{
	...
	[
		...
		{ outputFolder: process.env.ALLURE_RESULTS_DIR ?? './e2e/allure-results' },
	],
];
