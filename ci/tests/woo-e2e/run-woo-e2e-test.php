...
$base_command = "QIT_NO_PULL=1 QIT_RESULTS_DIR='./results' QIT_TEST_RUN_ID=$test_run_id ./qit run:woo-e2e $woo_id --source ../../$type/$slug --wp $wp --woo $woocommerce --php_version $php_version";
