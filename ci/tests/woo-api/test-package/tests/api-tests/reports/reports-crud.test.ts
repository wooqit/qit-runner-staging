			...
			expect.arrayContaining( [
				expect.objectContaining( {
					...
					totals: expect.objectContaining( {
						// Use objectContaining so additive changes to the daily
						// totals shape in WooCommerce Core (e.g. the `refunds`
						// key added in 11.0) don't fail extension compat runs.
						[ dateString ]: expect.objectContaining( {
