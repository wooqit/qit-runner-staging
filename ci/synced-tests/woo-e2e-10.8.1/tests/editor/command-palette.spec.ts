...
test.skip( 'can use the "Add new product" command', async ( { page } ) => {
...
test.skip( 'can use the "Add new order" command', async ( { page } ) => {
	await clickOnCommandPaletteOption( {
		page,
...
test.skip( 'can use the "Products" command', async ( { page } ) => {
	await clickOnCommandPaletteOption( {
		page,
		optionName: 'Products',
	} );
...
test.skip( 'can use the "Orders" command', async ( { page } ) => {
	await clickOnCommandPaletteOption( {
		page,
		optionName: 'Orders',
	} );
...
test.skip( 'can use the product search command', async ( { page, product } ) => {
	await clickOnCommandPaletteOption( {
		page,
...
test.skip( 'can use an analytics command', async ( { page } ) => {
	await clickOnCommandPaletteOption( {
		page,
