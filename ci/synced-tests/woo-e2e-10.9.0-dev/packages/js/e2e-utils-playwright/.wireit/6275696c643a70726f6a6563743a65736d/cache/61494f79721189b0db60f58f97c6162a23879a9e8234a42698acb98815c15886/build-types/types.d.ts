...
export interface ApiClient {
     ...
     */
    get<T = unknown>(path: string, params?: Record<string, unknown>, debug?: boolean): Promise<AxiosResponse<T>>;
    /**
     * Make a POST request.
     *
     * @template T - The expected response data type
     ...
     * @return Promise resolving to the response
     */
    post<T = unknown>(path: string, data?: Record<string, unknown>, debug?: boolean): Promise<AxiosResponse<T>>;
    /**
     * Make a PUT request.
     *
     * @template T - The expected response data type
     ...
     * @return Promise resolving to the response
     */
    put<T = unknown>(path: string, data?: Record<string, unknown>, debug?: boolean): Promise<AxiosResponse<T>>;
    /**
     ...
     * @return Promise resolving to the response
     */
    delete<T = unknown>(path: string, params?: Record<string, unknown>, debug?: boolean): Promise<AxiosResponse<T>>;
}
/**
