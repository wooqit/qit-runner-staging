...
test.describe( 'Update propagation — scope and allow-list', () => {
	 ...
	 */
	test.skip( 'Non-opted-in third-party email is excluded from sync', async ( {
		page,
	} ) => {
	 ...
	 *   "Show browser" eye: not needed.
	 */
	test.skip( 'Opted-in third-party email: version bump flips status when unedited', async () => {
	 ...
	 *   "Show browser" eye: not needed.
	 */
	test.skip( 'Opted-in third-party email: version bump flips status when edited', async () => {
