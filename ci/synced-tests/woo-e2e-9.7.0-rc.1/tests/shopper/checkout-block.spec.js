...
test.describe(
	...
	() => {
		...
		test.skip( 'allows guest customer to place an order', async ( {
			page,
			testPage,
		} ) => {
		...
		test.skip( 'allows existing customer to place an order', async ( {
			page,
			testPage,
		} ) => {
			await addAProductToCart( page, productId, 2 );
		...
		test.skip( 'can create an account during checkout', async ( {
			page,
			testPage,
		} ) => {
			await addAProductToCart( page, productId );
